...
//
// CHANGELOG v1.5.15:
// - [NEW] Show/Hide Rename Controls toggle button. All renaming controls
//         (Main list + Thruster list) are now hidden by default and only
//         appear after clicking the toggle button, which is always visible.
//         Fixes panel clutter/overlap on blocks with their own dynamic
//         terminal UI (e.g. vanilla Services Terminal's Precision Mode
//         toggle, Update 1.209 "Economy 2").
//
// CHANGELOG v1.5.14:
...
namespace BlockRenaming
{
    ...
    {
        private const string MOD_VERSION = "1.5.15";
        ...
        // Show/Hide rename controls toggle (default OFF — hidden until requested).
        // Keeps the terminal panel clean on every block and avoids overlapping
        // other mods'/vanilla's own block-specific controls (e.g. the new
        // Services Terminal's Precision Mode toggle).
        private static bool ShowRenameControls = false;
        ...
        private List<IMyTerminalControl> CreateControlList()
        {
            ...
            // Show/Hide toggle button — always visible, controls visibility of
            // every other control this mod adds (Main list + Thruster list).
            var toggleBtn = MyAPIGateway.TerminalControls.CreateControl<
                IMyTerminalControlButton,
                IMyTerminalBlock
            >("Renamer_ToggleVisibilityButton");
            toggleBtn.Enabled = (b) => true;
            toggleBtn.SupportsMultipleBlocks = true;
            toggleBtn.Title = MyStringId.GetOrCompute("Show/Hide Rename Controls");
            toggleBtn.Tooltip = MyStringId.GetOrCompute(
                "Toggles visibility of all Block Renaming controls on this block"
            );
            toggleBtn.Action = (b) =>
            {
            ...
            separator0.Enabled = (b) => ShowRenameControls;
            ...
            var label0 = MyAPIGateway.TerminalControls.CreateControl<
                ...
                IMyTerminalBlock
            >("Renamer_Label");
            label0.Enabled = (b) => ShowRenameControls;
            ...
            var textbox0 = MyAPIGateway.TerminalControls.CreateControl<
                ...
                IMyTerminalBlock
            >("Renamer_Textbox");
            textbox0.Enabled = (b) => ShowRenameControls;
            ...
            replaceBtn.Enabled = (b) => ShowRenameControls;
            ...
            prefixBtn.Enabled = (b) => ShowRenameControls;
            ...
            suffixBtn.Enabled = (b) => ShowRenameControls;
            ...
            counterTxt.Enabled = (b) => ShowRenameControls;
            ...
            autoContinueCheckbox.Enabled = (b) => ShowRenameControls;
            ...
            separatorTxt.Enabled = (b) => ShowRenameControls;
            ...
            groupCheckbox.Enabled = (b) => ShowRenameControls;
            ...
            resetCounterBtn.Enabled = (b) => ShowRenameControls;
            ...
            numPrefixBtn.Enabled = (b) => ShowRenameControls;
            ...
            numBtn.Enabled = (b) => ShowRenameControls;
            ...
            var resetBtn = MyAPIGateway.TerminalControls.CreateControl<
                ...
                IMyTerminalBlock
            >("Renamer_ResetButton");
            resetBtn.Enabled = (b) => ShowRenameControls;
            ...
            var regexSep = MyAPIGateway.TerminalControls.CreateControl<
                ...
                IMyTerminalBlock
            >("RegRen_Separator");
            regexSep.Enabled = (b) => ShowRenameControls;
            ...
            var findTxt = MyAPIGateway.TerminalControls.CreateControl<
                ...
                IMyTerminalBlock
            >("RegRen_FindTextbox");
            findTxt.Enabled = (b) => ShowRenameControls;
            ...
            regexReplaceTxt.Enabled = (b) => ShowRenameControls;
            ...
            regexBtn.Enabled = (b) => ShowRenameControls;
        ...
        private List<IMyTerminalControl> CreateThrusterControlList()
        {
            ...
            var thrusterSep = MyAPIGateway.TerminalControls.CreateControl<
                ...
                IMyThrust
            >("TR_Separator");
            thrusterSep.Enabled = (b) => ShowRenameControls;
            ...
            var thrusterTxt = MyAPIGateway.TerminalControls.CreateControl<
                ...
                IMyThrust
            >("TR_TemplateTextbox");
            thrusterTxt.Enabled = (b) => ShowRenameControls;
            ...
            var btn = MyAPIGateway.TerminalControls.CreateControl<
                ...
                IMyThrust
            >("TR_RenameButton");
            btn.Enabled = (b) => ShowRenameControls;
